...
directory = '/home/umflint.edu/brayclou/Health-AI-CLPsych/crowd-test-llama-3.2-finetuned-50epochs.csv'
...
print(f"Instances ? predictions: {len([x for x in y_pred if x == '?'])}\n")
